...
class Createtask extends Component {
    ...
    checkerror = (event) => {
        ...
        switch (name) {
            case 'title':
            errors.title = value.length < 1 ? errors.title : '';
            break;
            case 'description':
        ...
        render() {
            ...
            return (
                ...
                <input type="text" value={description} name = "description" id = "description" className="form-control" placeholder="Enter description" style={{height:"164px"}} onChange ={(e) => {this.inputchange(e) }} />
                ...
                <input type="datetime-local" value={deadline} name = "deadline" id = "deadline" className="form-control" placeholder="YY-MM-DD" onChange ={(e) => {this.inputchange(e) }} />
                </div>
